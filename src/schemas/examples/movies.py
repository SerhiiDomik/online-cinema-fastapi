certification_example = {"id": 1, "name": "PG-13"}

genre_example = {"id": 1, "name": "Action", "movie_count": 150}

star_example = {"id": 1, "name": "Leonardo DiCaprio"}

director_example = {"id": 1, "name": "Christopher Nolan"}
...
movie_detail_example = {**movie_list_item_example, "meta_score": 74.0, "gross": 836.8}
